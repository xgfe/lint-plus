...
describe('reporter tool', function () {
    ...
    var msgs = {};
    msgs[filepath] = [
        {type:'type1',severity:'severity1',line:'line1',col:'col1',message:'message1',rule:'rule1'},
        {type:'type2',severity:'severity2',line:'line2',col:'col2',message:'message2',rule:'rule2'}
    ];
    var reporter;
    beforeEach(function () {
